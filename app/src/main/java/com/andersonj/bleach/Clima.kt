...
import com.andersonj.bleach.R
import com.andersonj.bleach.databinding.ActivityClimaBinding
import com.sunayanpradhan.weatherapptutorial.Utilites.ApiUtilities
import com.andersonj.bleach.databinding.ActivityMainBinding
...
class Clima : AppCompatActivity() {
    ...
    lateinit var binding: ActivityClimaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_clima)
                ...
                override fun onResponse(call: Call<WeatherModel>, response: Response<WeatherModel>) {
                    if (response.isSuccessful){
                        ...
                        if (mInterstitialAd!=null){
                            ...
                            mInterstitialAd!!.show(this@Clima)
                        ...
                        Toast.makeText(this@Clima, "No City Found",
            ...
            when (id) {
                ...
                in 200..232 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@Clima, R.drawable.thunderstrom_bg)
                ...
                in 300..321 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@Clima, R.drawable.drizzle_bg)
                ...
                in 500..531 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@Clima, R.drawable.rain_bg)
                ...
                in 600..622 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@Clima, R.drawable.snow_bg)
                ...
                in 701..781 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@Clima, R.drawable.atmosphere_bg)
                ...
                800 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@Clima, R.drawable.clear_bg)
                ...
                in 801..804 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@Clima, R.drawable.clouds_bg)
                ...
                //unknown
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@Clima, R.drawable.unknown_bg)
